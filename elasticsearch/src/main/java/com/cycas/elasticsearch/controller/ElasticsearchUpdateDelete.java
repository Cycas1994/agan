...
public class ElasticsearchUpdateDelete {
    ...
    public static void main(String[] args) throws IOException {
        ...
        IndexResponse indexResponse4 = client.index(request4, RequestOptions.DEFAULT);
        ...
        Map<String, Object> updateMap6 = new HashMap<>();

...
public class CustomerRedisTemplateTest {
    ...
    public void test003() {
        ...
        // HKEYS key 获取在哈希表中指定key的所有字段
        Set<String> keySet = redisHash.keys("hashKey");
        System.out.println(keySet);
        // HVALS key 获取在哈希表中指定key的所有值
    ...
    public void test005() {
        ...
        redisSet.add("setKey", "cSet");
        // SMEMBERS key: 返回集合中的所有成员
        Set<Object> set = redisSet.members("setKey");
        System.out.println(set);

        redisSet.add("setKey2", "bSet");
        redisSet.add("setKey2", "cSet");
        redisSet.add("setKey2", "dSet");
        Set<Object> interSet = redisSet.intersect("setKey", "setKey2");
        System.out.println("interSet:" + interSet);

        Set<Object> unionSet = redisSet.union("setKey", "setKey2");
        System.out.println("unionSet:" + unionSet);

        Set<Object> diffSet = redisSet.difference("setKey", "setKey2");
